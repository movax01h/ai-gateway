FROM python:3.12.13-slim AS base-image
...
RUN poetry run fetch-foundational-agents "https://gitlab.com" "$GITLAB_API_TOKEN" "duo_planner:348,security_analyst_agent:356,pipeline_builder:1004583" \
