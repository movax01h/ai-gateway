...
func (*Approval_Approved) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{30, 0}
}
...
func (*Approval_Rejected) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{30, 1}
}
...
var file_contract_contract_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe0, 0x05, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f,
	...
	0x72, 0x75, 0x6e, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x42,
	0x08, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2b, 0x0a, 0x0f, 0x52, 0x75, 0x6e,
	...
	0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x89, 0x01, 0x0a, 0x10, 0x52, 0x75, 0x6e, 0x43, 0x6f,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4b, 0x0a, 0x15, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65,
	...
	0x74, 0x22, 0x12, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x6f, 0x6f, 0x6c, 0x73, 0x52, 0x65,
	...
	0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x78, 0x0a, 0x04, 0x47, 0x72, 0x65, 0x70, 0x12,
	0x2a, 0x0a, 0x10, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x5f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x73, 0x65, 0x61, 0x72, 0x63,
	0x68, 0x5f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x70,
	0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61,
	0x74, 0x74, 0x65, 0x72, 0x6e, 0x12, 0x2a, 0x0a, 0x10, 0x63, 0x61, 0x73, 0x65, 0x5f, 0x69, 0x6e,
	...
	0x65, 0x22, 0x2f, 0x0a, 0x09, 0x46, 0x69, 0x6e, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x22,
	0x0a, 0x0c, 0x6e, 0x61, 0x6d, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6e, 0x61, 0x6d, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x74, 0x65,
	0x72, 0x6e, 0x22, 0x61, 0x0a, 0x07, 0x4d, 0x63, 0x70, 0x54, 0x6f, 0x6f, 0x6c, 0x12, 0x12, 0x0a,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x34, 0x0a, 0x0a, 0x52, 0x75, 0x6e, 0x4d, 0x43, 0x50, 0x54,
	...
	0x04, 0x5f, 0x63, 0x77, 0x64, 0x32, 0xe3, 0x01, 0x0a, 0x0b, 0x44, 0x75, 0x6f, 0x57, 0x6f, 0x72,
	...
	0x6f, 0x77, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x68, 0x5a, 0x51, 0x67,
...
var file_contract_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_contract_contract_proto_goTypes = []any{
	...
	(*Action)(nil),                  // 7: Action
	(*RunShellCommand)(nil),         // 8: RunShellCommand
	(*RunCommandAction)(nil),        // 9: RunCommandAction
	(*ReadFile)(nil),                // 10: ReadFile
	(*ReadFiles)(nil),               // 11: ReadFiles
	(*WriteFile)(nil),               // 12: WriteFile
	(*EditFile)(nil),                // 13: EditFile
	(*RunHTTPRequest)(nil),          // 14: RunHTTPRequest
	(*RunGitCommand)(nil),           // 15: RunGitCommand
	(*GenerateTokenRequest)(nil),    // 16: GenerateTokenRequest
	(*GenerateTokenResponse)(nil),   // 17: GenerateTokenResponse
	(*ListToolsRequest)(nil),        // 18: ListToolsRequest
	(*ListToolsResponse)(nil),       // 19: ListToolsResponse
	(*ListFlowsRequest)(nil),        // 20: ListFlowsRequest
	(*ListFlowsRequestFilter)(nil),  // 21: ListFlowsRequestFilter
	(*ListFlowsResponse)(nil),       // 22: ListFlowsResponse
	(*NewCheckpoint)(nil),           // 23: NewCheckpoint
	(*ListDirectory)(nil),           // 24: ListDirectory
	(*Grep)(nil),                    // 25: Grep
	(*FindFiles)(nil),               // 26: FindFiles
	(*McpTool)(nil),                 // 27: McpTool
	(*RunMCPTool)(nil),              // 28: RunMCPTool
	(*AdditionalContext)(nil),       // 29: AdditionalContext
	(*Approval)(nil),                // 30: Approval
	(*Mkdir)(nil),                   // 31: Mkdir
	(*OsInformationContext)(nil),    // 32: OsInformationContext
	(*ShellInformationContext)(nil), // 33: ShellInformationContext
	nil,                             // 34: HttpResponse.HeadersEntry
	(*Approval_Approved)(nil),       // 35: Approval.Approved
	(*Approval_Rejected)(nil),       // 36: Approval.Rejected
...
var file_contract_contract_proto_depIdxs = []int32{
	...
	27, // 4: StartWorkflowRequest.mcpTools:type_name -> McpTool
	29, // 5: StartWorkflowRequest.additional_context:type_name -> AdditionalContext
	30, // 6: StartWorkflowRequest.approval:type_name -> Approval
	37, // 7: StartWorkflowRequest.flowConfig:type_name -> google.protobuf.Struct
	5,  // 8: ActionResponse.plainTextResponse:type_name -> PlainTextResponse
	6,  // 9: ActionResponse.httpResponse:type_name -> HttpResponse
	34, // 10: HttpResponse.headers:type_name -> HttpResponse.HeadersEntry
	9,  // 11: Action.runCommand:type_name -> RunCommandAction
	14, // 12: Action.runHTTPRequest:type_name -> RunHTTPRequest
	10, // 13: Action.runReadFile:type_name -> ReadFile
	12, // 14: Action.runWriteFile:type_name -> WriteFile
	15, // 15: Action.runGitCommand:type_name -> RunGitCommand
	13, // 16: Action.runEditFile:type_name -> EditFile
	23, // 17: Action.newCheckpoint:type_name -> NewCheckpoint
	24, // 18: Action.listDirectory:type_name -> ListDirectory
	25, // 19: Action.grep:type_name -> Grep
	26, // 20: Action.findFiles:type_name -> FindFiles
	28, // 21: Action.runMCPTool:type_name -> RunMCPTool
	31, // 22: Action.mkdir:type_name -> Mkdir
	11, // 23: Action.runReadFiles:type_name -> ReadFiles
	8,  // 24: Action.runShellCommand:type_name -> RunShellCommand
	37, // 25: ListToolsResponse.tools:type_name -> google.protobuf.Struct
	37, // 26: ListToolsResponse.eval_dataset:type_name -> google.protobuf.Struct
	21, // 27: ListFlowsRequest.filters:type_name -> ListFlowsRequestFilter
	37, // 28: ListFlowsResponse.configs:type_name -> google.protobuf.Struct
	35, // 29: Approval.approval:type_name -> Approval.Approved
	36, // 30: Approval.rejection:type_name -> Approval.Rejected
	0,  // 31: DuoWorkflow.ExecuteWorkflow:input_type -> ClientEvent
	16, // 32: DuoWorkflow.GenerateToken:input_type -> GenerateTokenRequest
	18, // 33: DuoWorkflow.ListTools:input_type -> ListToolsRequest
	20, // 34: DuoWorkflow.ListFlows:input_type -> ListFlowsRequest
	7,  // 35: DuoWorkflow.ExecuteWorkflow:output_type -> Action
	17, // 36: DuoWorkflow.GenerateToken:output_type -> GenerateTokenResponse
	19, // 37: DuoWorkflow.ListTools:output_type -> ListToolsResponse
	22, // 38: DuoWorkflow.ListFlows:output_type -> ListFlowsResponse
