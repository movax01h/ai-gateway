...
var file_contract_contract_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xcd, 0x02,
	...
	0x6f, 0x6f, 0x6c, 0x52, 0x08, 0x6d, 0x63, 0x70, 0x54, 0x6f, 0x6f, 0x6c, 0x73, 0x22, 0xd4, 0x01,
...
var file_contract_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_contract_contract_proto_goTypes = []any{
	...
	nil,                           // 22: HttpResponse.HeadersEntry
}
var file_contract_contract_proto_depIdxs = []int32{
	...
	4,  // 4: ActionResponse.plainTextResponse:type_name -> PlainTextResponse
	5,  // 5: ActionResponse.httpResponse:type_name -> HttpResponse
	22, // 6: HttpResponse.headers:type_name -> HttpResponse.HeadersEntry
	7,  // 7: Action.runCommand:type_name -> RunCommandAction
	11, // 8: Action.runHTTPRequest:type_name -> RunHTTPRequest
	8,  // 9: Action.runReadFile:type_name -> ReadFile
	9,  // 10: Action.runWriteFile:type_name -> WriteFile
	12, // 11: Action.runGitCommand:type_name -> RunGitCommand
	10, // 12: Action.runEditFile:type_name -> EditFile
	16, // 13: Action.newCheckpoint:type_name -> NewCheckpoint
	17, // 14: Action.listDirectory:type_name -> ListDirectory
	18, // 15: Action.grep:type_name -> Grep
	19, // 16: Action.findFiles:type_name -> FindFiles
	21, // 17: Action.runMCPTool:type_name -> RunMCPTool
	0,  // 18: ContextElement.type:type_name -> ContextElementType
	1,  // 19: DuoWorkflow.ExecuteWorkflow:input_type -> ClientEvent
	13, // 20: DuoWorkflow.GenerateToken:input_type -> GenerateTokenRequest
	6,  // 21: DuoWorkflow.ExecuteWorkflow:output_type -> Action
	14, // 22: DuoWorkflow.GenerateToken:output_type -> GenerateTokenResponse
