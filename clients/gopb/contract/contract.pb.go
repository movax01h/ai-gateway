...
const (
	...
	// APPROVAL_SOURCE_SESSION_APPROVAL is produced server-side when a tool call is
	...
	Approval_APPROVAL_SOURCE_SESSION_APPROVAL Approval_ApprovalSource = 5
)
...
var (
	Approval_ApprovalSource_name = map[int32]string{
		...
		5: "APPROVAL_SOURCE_SESSION_APPROVAL",
	}
...
func (Approval_ApprovalSource) EnumDescriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{44, 0}
}
...
type StartWorkflowRequest struct {
	...
	CatalogItems *CatalogItems `protobuf:"bytes,18,opt,name=catalog_items,proto3,oneof" json:"catalog_items,omitempty"`
}
...
func (x *StartWorkflowRequest) GetCatalogItems() *CatalogItems {
	if x != nil {
...
type CatalogItems struct {
	...
	// items carries the item declarations for one schema version.
	//
	// Types that are assignable to Items:
	//
	//	*CatalogItems_CatalogItemsV1
	Items isCatalogItems_Items `protobuf_oneof:"items"`
}

func (x *CatalogItems) Reset() {
	*x = CatalogItems{}
...
func (x *CatalogItems) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CatalogItems) ProtoMessage() {}

func (x *CatalogItems) ProtoReflect() protoreflect.Message {
	mi := &file_contract_contract_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CatalogItems.ProtoReflect.Descriptor instead.
func (*CatalogItems) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{2}
}

func (m *CatalogItems) GetItems() isCatalogItems_Items {
	if m != nil {
		return m.Items
	}
	return nil
...
func (x *CatalogItems) GetCatalogItemsV1() *CatalogItemsV1 {
	if x, ok := x.GetItems().(*CatalogItems_CatalogItemsV1); ok {
		return x.CatalogItemsV1
	}
	return nil
}

type isCatalogItems_Items interface {
	isCatalogItems_Items()
}

type CatalogItems_CatalogItemsV1 struct {
	// catalog_items_v1 is the v1 schema for catalog item declarations.
	CatalogItemsV1 *CatalogItemsV1 `protobuf:"bytes,1,opt,name=catalog_items_v1,proto3,oneof"`
}

func (*CatalogItems_CatalogItemsV1) isCatalogItems_Items() {}

// CatalogItemsV1 is the v1 schema for catalog item declarations, keyed by item kind.
type CatalogItemsV1 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	WorkspaceAgents []*WorkspaceAgent `protobuf:"bytes,1,rep,name=workspace_agents,proto3" json:"workspace_agents,omitempty"`
}

func (x *CatalogItemsV1) Reset() {
	*x = CatalogItemsV1{}
...
func (x *CatalogItemsV1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CatalogItemsV1) ProtoMessage() {}

func (x *CatalogItemsV1) ProtoReflect() protoreflect.Message {
	mi := &file_contract_contract_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CatalogItemsV1.ProtoReflect.Descriptor instead.
func (*CatalogItemsV1) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{3}
}

func (x *CatalogItemsV1) GetWorkspaceAgents() []*WorkspaceAgent {
	if x != nil {
		return x.WorkspaceAgents
	}
	return nil
}
...
type WorkspaceAgent struct {
	...
	Toolset []string `protobuf:"bytes,3,rep,name=toolset,proto3" json:"toolset,omitempty"`
	// prompt is the system prompt defining the agent's behaviour. Required.
	Prompt string `protobuf:"bytes,4,opt,name=prompt,proto3" json:"prompt,omitempty"`
}

func (x *WorkspaceAgent) Reset() {
	*x = WorkspaceAgent{}
...
func (x *WorkspaceAgent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceAgent) ProtoMessage() {}

func (x *WorkspaceAgent) ProtoReflect() protoreflect.Message {
	mi := &file_contract_contract_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceAgent.ProtoReflect.Descriptor instead.
func (*WorkspaceAgent) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{4}
}

func (x *WorkspaceAgent) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *WorkspaceAgent) GetDescription() string {
	if x != nil {
...
func (x *WorkspaceAgent) GetToolset() []string {
	if x != nil {
		return x.Toolset
	}
	return nil
...
func (x *WorkspaceAgent) GetPrompt() string {
	if x != nil {
		return x.Prompt
	}
	return ""
...
type ActionResponse struct {
	...
	//	*ActionResponse_ScheduleNotificationResponse
	//	*ActionResponse_ImageResponse
...
func (x *ActionResponse) GetScheduleNotificationResponse() *ScheduleNotificationResponse {
	if x, ok := x.GetResponseType().(*ActionResponse_ScheduleNotificationResponse); ok {
		return x.ScheduleNotificationResponse
	}
	return nil
}

func (x *ActionResponse) GetImageResponse() *ImageResponse {
	if x, ok := x.GetResponseType().(*ActionResponse_ImageResponse); ok {
...
type ActionResponse_ScheduleNotificationResponse struct {
	// scheduleNotificationResponse acknowledges a ScheduleNotification action.
	ScheduleNotificationResponse *ScheduleNotificationResponse `protobuf:"bytes,5,opt,name=scheduleNotificationResponse,proto3,oneof"`
}
...
func (*ActionResponse_ScheduleNotificationResponse) isActionResponse_ResponseType() {}

func (*ActionResponse_ImageResponse) isActionResponse_ResponseType() {}
...
type ScheduleNotificationResponse struct {
	...
	FiresAt string `protobuf:"bytes,3,opt,name=fires_at,proto3" json:"fires_at,omitempty"`
}
...
func (x *ScheduleNotificationResponse) GetAccepted() bool {
	if x != nil {
		return x.Accepted
	}
	return false
...
func (x *ScheduleNotificationResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *ScheduleNotificationResponse) GetFiresAt() string {
	if x != nil {
		return x.FiresAt
	}
	return ""
...
func (x *Action) GetScheduleNotification() *ScheduleNotification {
	if x, ok := x.GetAction().(*Action_ScheduleNotification); ok {
		return x.ScheduleNotification
	}
	return nil
}
...
type Action_ScheduleNotification struct {
	// scheduleNotification asks the executor to deliver a message into this session
	// once a condition occurs.
	ScheduleNotification *ScheduleNotification `protobuf:"bytes,17,opt,name=scheduleNotification,proto3,oneof"`
}
...
func (*Action_ScheduleNotification) isAction_Action() {}
...
func (x *ScheduleNotification) Reset() {
...
func (x *ScheduleNotification) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScheduleNotification) ProtoMessage() {}

func (x *ScheduleNotification) ProtoReflect() protoreflect.Message {
	mi := &file_contract_contract_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScheduleNotification.ProtoReflect.Descriptor instead.
func (*ScheduleNotification) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{13}
}

func (x *ScheduleNotification) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *ScheduleNotification) GetCondition() string {
	if x != nil {
		return x.Condition
	}
	return ""
...
func (x *ScheduleNotification) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GenerateTokenRequest) GetFlowConfigId() string {
	if x != nil && x.FlowConfigId != nil {
		return *x.FlowConfigId
	}
	return ""
...
type McpTool struct {
	...
	ClientInjected *bool `protobuf:"varint,7,opt,name=client_injected,json=clientInjected,proto3,oneof" json:"client_injected,omitempty"`
}
...
func (x *McpTool) GetClientInjected() bool {
	if x != nil && x.ClientInjected != nil {
		return *x.ClientInjected
	}
	return false
}
...
func (*OsInformationContext) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{46}
}
...
func (x *ShellInformationContext) Reset() {
	*x = ShellInformationContext{}
	mi := &file_contract_contract_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ShellInformationContext) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{47}
}
...
func (*TrackSelfHostedClientEvent) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{48}
}
...
func (*TrackSelfHostedAction) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{49}
}
...
func (*ValidateFlowConfigRequest) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{50}
}
...
func (x *ValidateFlowConfigResponse) Reset() {
	*x = ValidateFlowConfigResponse{}
	mi := &file_contract_contract_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ValidateFlowConfigResponse) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{51}
}
...
func (x *Approval_PolicyRef) Reset() {
	*x = Approval_PolicyRef{}
	mi := &file_contract_contract_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Approval_Approved) Reset() {
	*x = Approval_Approved{}
	mi := &file_contract_contract_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Approval_Approved) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{44, 1}
}
...
func (x *Approval_Rejected) Reset() {
	*x = Approval_Rejected{}
	mi := &file_contract_contract_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Approval_Rejected) Descriptor() ([]byte, []int) {
	return file_contract_contract_proto_rawDescGZIP(), []int{44, 2}
}
...
var file_contract_contract_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xbf, 0x07, 0x0a, 0x14, 0x53,
	...
	,
	...
	0x6f, 0x6f, 0x6c, 0x73, 0x65, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x74, 0x6f,
	0x6f, 0x6c, 0x73, 0x65, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x22, 0xe5, 0x02,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x45, 0x0a, 0x11, 0x50, 0x6c, 0x61, 0x69, 0x6e, 0x54,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x6e, 0x0a, 0x1c, 0x53, 0x63,
	...
	,
	...
	0x6c, 0x61, 0x67, 0x73, 0x12, 0x1d, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74,
	0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x4a,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x22, 0x73, 0x0a, 0x08, 0x52, 0x65, 0x61, 0x64,
	...
	0x69, 0x74, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x29, 0x0a,
	...
	0x79, 0x22, 0x82, 0x01, 0x0a, 0x0d, 0x52, 0x75, 0x6e, 0x47, 0x69, 0x74, 0x43, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x12, 0x2f, 0x0a, 0x13, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x5f, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x12, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x43, 0x61, 0x70, 0x61, 0x62,
	0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x22, 0x3c, 0x0a, 0x0a, 0x43, 0x61, 0x70, 0x61, 0x62,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x73, 0x22, 0xa1, 0x02, 0x0a, 0x0d, 0x4e, 0x65, 0x77, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x09, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x12, 0x55, 0x0a, 0x13, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65,
	0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x4e, 0x65, 0x77, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x74,
	0x65, 0x78, 0x74, 0x55, 0x73, 0x61, 0x67, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x11, 0x61,
	0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x55, 0x73, 0x61, 0x67, 0x65,
	0x1a, 0x55, 0x0a, 0x16, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x64, 0x6f, 0x77, 0x6e, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x2d, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x44,
	...
	,
	...
	0x22, 0xb3, 0x07, 0x0a, 0x08, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x12, 0x30, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x1a, 0xa2, 0x01, 0x0a, 0x09, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65,
	0x66, 0x12, 0x1b, 0x0a, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x17,
	0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x04,
	0x66, 0x69, 0x6c, 0x65, 0x88, 0x01, 0x01, 0x12, 0x17, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18,
	...
	,
	...
	,
	...
	0x74, 0x49, 0x44, 0x22, 0x6c, 0x0a, 0x19, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x46,
	0x6c, 0x6f, 0x77, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x39, 0x0a, 0x0b, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18,
	...
	0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4a, 0x04, 0x08, 0x02, 0x10,
	0x03, 0x52, 0x0e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x22, 0x4a, 0x0a, 0x1a, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x46, 0x6c, 0x6f,
	...
	0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x32, 0xd6, 0x03,
	...
	0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x47, 0x0a, 0x10, 0x4c,
	0x69, 0x73, 0x74, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12,
	0x18, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x6f, 0x6f, 0x6c,
	0x73, 0x12, 0x11, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x6f, 0x6f, 0x6c, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x6f, 0x6f, 0x6c, 0x73,
	...
	,
...
var file_contract_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_contract_contract_proto_goTypes = []any{
	...
	(*CatalogItems)(nil),                 // 3: CatalogItems
	(*CatalogItemsV1)(nil),               // 4: CatalogItemsV1
	(*WorkspaceAgent)(nil),               // 5: WorkspaceAgent
	(*ActionResponse)(nil),               // 6: ActionResponse
	(*HeartbeatRequest)(nil),             // 7: HeartbeatRequest
	(*StopWorkflowRequest)(nil),          // 8: StopWorkflowRequest
	(*PlainTextResponse)(nil),            // 9: PlainTextResponse
	(*HttpResponse)(nil),                 // 10: HttpResponse
	(*ScheduleNotificationResponse)(nil), // 11: ScheduleNotificationResponse
	(*ImageResponse)(nil),                // 12: ImageResponse
	(*Action)(nil),                       // 13: Action
	(*ScheduleNotification)(nil),         // 14: ScheduleNotification
	(*TrackLlmCallForSelfHosted)(nil),    // 15: TrackLlmCallForSelfHosted
	(*RunShellCommand)(nil),              // 16: RunShellCommand
	(*RunCommandAction)(nil),             // 17: RunCommandAction
	(*ReadFile)(nil),                     // 18: ReadFile
	(*ReadFiles)(nil),                    // 19: ReadFiles
	(*WriteFile)(nil),                    // 20: WriteFile
	(*EditFile)(nil),                     // 21: EditFile
	(*RunHTTPRequest)(nil),               // 22: RunHTTPRequest
	(*RunGitCommand)(nil),                // 23: RunGitCommand
	(*GenerateTokenRequest)(nil),         // 24: GenerateTokenRequest
	(*GenerateTokenResponse)(nil),        // 25: GenerateTokenResponse
	(*Capability)(nil),                   // 26: Capability
	(*ListCapabilitiesRequest)(nil),      // 27: ListCapabilitiesRequest
	(*ListCapabilitiesResponse)(nil),     // 28: ListCapabilitiesResponse
	(*ListToolsRequest)(nil),             // 29: ListToolsRequest
	(*ListToolsResponse)(nil),            // 30: ListToolsResponse
	(*ListFlowsRequest)(nil),             // 31: ListFlowsRequest
	(*ListFlowsRequestFilter)(nil),       // 32: ListFlowsRequestFilter
	(*ListFlowsResponse)(nil),            // 33: ListFlowsResponse
	(*TokenBreakdown)(nil),               // 34: TokenBreakdown
	(*NewCheckpoint)(nil),                // 35: NewCheckpoint
	(*ListDirectory)(nil),                // 36: ListDirectory
	(*Grep)(nil),                         // 37: Grep
	(*FindFiles)(nil),                    // 38: FindFiles
	(*Icon)(nil),                         // 39: Icon
	(*ToolAnnotations)(nil),              // 40: ToolAnnotations
	(*McpTool)(nil),                      // 41: McpTool
	(*Icons)(nil),                        // 42: Icons
	(*RunMCPTool)(nil),                   // 43: RunMCPTool
	(*AdditionalContext)(nil),            // 44: AdditionalContext
	(*Approval)(nil),                     // 45: Approval
	(*Mkdir)(nil),                        // 46: Mkdir
	(*OsInformationContext)(nil),         // 47: OsInformationContext
	(*ShellInformationContext)(nil),      // 48: ShellInformationContext
	(*TrackSelfHostedClientEvent)(nil),   // 49: TrackSelfHostedClientEvent
	(*TrackSelfHostedAction)(nil),        // 50: TrackSelfHostedAction
	(*ValidateFlowConfigRequest)(nil),    // 51: ValidateFlowConfigRequest
	(*ValidateFlowConfigResponse)(nil),   // 52: ValidateFlowConfigResponse
	nil,                                  // 53: HttpResponse.HeadersEntry
	nil,                                  // 54: NewCheckpoint.AgentContextUsageEntry
	(*Approval_PolicyRef)(nil),           // 55: Approval.PolicyRef
	(*Approval_Approved)(nil),            // 56: Approval.Approved
	(*Approval_Rejected)(nil),            // 57: Approval.Rejected
...
var file_contract_contract_proto_depIdxs = []int32{
	...
	6,  // 1: ClientEvent.actionResponse:type_name -> ActionResponse
	7,  // 2: ClientEvent.heartbeat:type_name -> HeartbeatRequest
	8,  // 3: ClientEvent.stopWorkflow:type_name -> StopWorkflowRequest
	41, // 4: StartWorkflowRequest.mcpTools:type_name -> McpTool
	44, // 5: StartWorkflowRequest.additional_context:type_name -> AdditionalContext
	45, // 6: StartWorkflowRequest.approval:type_name -> Approval
	58, // 7: StartWorkflowRequest.flowConfig:type_name -> google.protobuf.Struct
	3,  // 8: StartWorkflowRequest.catalog_items:type_name -> CatalogItems
	4,  // 9: CatalogItems.catalog_items_v1:type_name -> CatalogItemsV1
	5,  // 10: CatalogItemsV1.workspace_agents:type_name -> WorkspaceAgent
	9,  // 11: ActionResponse.plainTextResponse:type_name -> PlainTextResponse
	10, // 12: ActionResponse.httpResponse:type_name -> HttpResponse
	11, // 13: ActionResponse.scheduleNotificationResponse:type_name -> ScheduleNotificationResponse
	12, // 14: ActionResponse.imageResponse:type_name -> ImageResponse
	53, // 15: HttpResponse.headers:type_name -> HttpResponse.HeadersEntry
	17, // 16: Action.runCommand:type_name -> RunCommandAction
	22, // 17: Action.runHTTPRequest:type_name -> RunHTTPRequest
	18, // 18: Action.runReadFile:type_name -> ReadFile
	20, // 19: Action.runWriteFile:type_name -> WriteFile
	23, // 20: Action.runGitCommand:type_name -> RunGitCommand
	21, // 21: Action.runEditFile:type_name -> EditFile
	35, // 22: Action.newCheckpoint:type_name -> NewCheckpoint
	36, // 23: Action.listDirectory:type_name -> ListDirectory
	37, // 24: Action.grep:type_name -> Grep
	38, // 25: Action.findFiles:type_name -> FindFiles
	43, // 26: Action.runMCPTool:type_name -> RunMCPTool
	46, // 27: Action.mkdir:type_name -> Mkdir
	19, // 28: Action.runReadFiles:type_name -> ReadFiles
	16, // 29: Action.runShellCommand:type_name -> RunShellCommand
	15, // 30: Action.trackLlmCallForSelfHosted:type_name -> TrackLlmCallForSelfHosted
	14, // 31: Action.scheduleNotification:type_name -> ScheduleNotification
	58, // 32: GenerateTokenRequest.flow_config:type_name -> google.protobuf.Struct
	26, // 33: ListCapabilitiesResponse.capabilities:type_name -> Capability
	58, // 34: ListToolsResponse.tools:type_name -> google.protobuf.Struct
	58, // 35: ListToolsResponse.eval_dataset:type_name -> google.protobuf.Struct
	32, // 36: ListFlowsRequest.filters:type_name -> ListFlowsRequestFilter
	58, // 37: ListFlowsResponse.configs:type_name -> google.protobuf.Struct
	54, // 38: NewCheckpoint.agent_context_usage:type_name -> NewCheckpoint.AgentContextUsageEntry
	42, // 39: McpTool.icons:type_name -> Icons
	40, // 40: McpTool.annotations:type_name -> ToolAnnotations
	39, // 41: Icons.items:type_name -> Icon
	56, // 42: Approval.approval:type_name -> Approval.Approved
	57, // 43: Approval.rejection:type_name -> Approval.Rejected
	58, // 44: ValidateFlowConfigRequest.flow_config:type_name -> google.protobuf.Struct
	34, // 45: NewCheckpoint.AgentContextUsageEntry.value:type_name -> TokenBreakdown
	0,  // 46: Approval.Approved.approval_source:type_name -> Approval.ApprovalSource
	55, // 47: Approval.Approved.policy_ref:type_name -> Approval.PolicyRef
	1,  // 48: DuoWorkflow.ExecuteWorkflow:input_type -> ClientEvent
	24, // 49: DuoWorkflow.GenerateToken:input_type -> GenerateTokenRequest
	27, // 50: DuoWorkflow.ListCapabilities:input_type -> ListCapabilitiesRequest
	29, // 51: DuoWorkflow.ListTools:input_type -> ListToolsRequest
	31, // 52: DuoWorkflow.ListFlows:input_type -> ListFlowsRequest
	49, // 53: DuoWorkflow.TrackSelfHostedExecuteWorkflow:input_type -> TrackSelfHostedClientEvent
	51, // 54: DuoWorkflow.ValidateFlowConfig:input_type -> ValidateFlowConfigRequest
	13, // 55: DuoWorkflow.ExecuteWorkflow:output_type -> Action
	25, // 56: DuoWorkflow.GenerateToken:output_type -> GenerateTokenResponse
	28, // 57: DuoWorkflow.ListCapabilities:output_type -> ListCapabilitiesResponse
	30, // 58: DuoWorkflow.ListTools:output_type -> ListToolsResponse
	33, // 59: DuoWorkflow.ListFlows:output_type -> ListFlowsResponse
	50, // 60: DuoWorkflow.TrackSelfHostedExecuteWorkflow:output_type -> TrackSelfHostedAction
	52, // 61: DuoWorkflow.ValidateFlowConfig:output_type -> ValidateFlowConfigResponse
...
func file_contract_contract_proto_init() {
	...
	file_contract_contract_proto_msgTypes[2].OneofWrappers = []any{
		(*CatalogItems_CatalogItemsV1)(nil),
	}
	file_contract_contract_proto_msgTypes[5].OneofWrappers = []any{
		...
		(*ActionResponse_ScheduleNotificationResponse)(nil),
		(*ActionResponse_ImageResponse)(nil),
	}
	file_contract_contract_proto_msgTypes[12].OneofWrappers = []any{
		...
		(*Action_ScheduleNotification)(nil),
	}
	...
	file_contract_contract_proto_msgTypes[39].OneofWrappers = []any{}
	file_contract_contract_proto_msgTypes[40].OneofWrappers = []any{}
	file_contract_contract_proto_msgTypes[43].OneofWrappers = []any{}
	file_contract_contract_proto_msgTypes[44].OneofWrappers = []any{
		(*Approval_Approval)(nil),
		(*Approval_Rejection)(nil),
	}
	file_contract_contract_proto_msgTypes[47].OneofWrappers = []any{}
	file_contract_contract_proto_msgTypes[54].OneofWrappers = []any{}
	file_contract_contract_proto_msgTypes[55].OneofWrappers = []any{}
	file_contract_contract_proto_msgTypes[56].OneofWrappers = []any{}
	type x struct{}
