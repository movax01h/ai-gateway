...
var file_contract_contract_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x22, 0x73, 0x0a, 0x0d, 0x4e, 0x65, 0x77, 0x43, 0x68, 0x65,
	...
	0x65, 0x32, 0x7b, 0x0a, 0x0b, 0x44, 0x75, 0x6f, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77,
	...
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x68,
...
var file_contract_contract_proto_depIdxs = []int32{
	...
	26, // 8: HttpResponse.headers:type_name -> HttpResponse.HeadersEntry
	7,  // 9: Action.runCommand:type_name -> RunCommandAction
	12, // 10: Action.runHTTPRequest:type_name -> RunHTTPRequest
	8,  // 11: Action.runReadFile:type_name -> ReadFile
	10, // 12: Action.runWriteFile:type_name -> WriteFile
	13, // 13: Action.runGitCommand:type_name -> RunGitCommand
	11, // 14: Action.runEditFile:type_name -> EditFile
	...
	9,  // 21: Action.runReadFiles:type_name -> ReadFiles
	27, // 22: Approval.approval:type_name -> Approval.Approved
	28, // 23: Approval.rejection:type_name -> Approval.Rejected
	0,  // 24: DuoWorkflow.ExecuteWorkflow:input_type -> ClientEvent
	14, // 25: DuoWorkflow.GenerateToken:input_type -> GenerateTokenRequest
	6,  // 26: DuoWorkflow.ExecuteWorkflow:output_type -> Action
	15, // 27: DuoWorkflow.GenerateToken:output_type -> GenerateTokenResponse
