...
class EventContext(BaseModel):
    """
    This model class represents the available attributes in Duo Workflow for the GitLab standard context.
    ...
    environment: Optional[str] = os.environ.get(
        "DUO_WORKFLOW_SERVICE_ENVIRONMENT", "development"
    )
    source: Optional[str] = "duo-workflow-service-python"
