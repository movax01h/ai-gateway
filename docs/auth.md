...
Tokens should be rotated in the following vaults for both staging and production environments. Anyone with vault access can perform these rotations, not just AI Framework team members. For additional help, contact the `#g_ai_framework` channel.
