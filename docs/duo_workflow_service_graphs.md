...
graph TD;
    ...
    set_remote(set_remote<br>#91;AgentComponent#93;);
    ...
    load_jenkins_file --> set_remote;
    set_remote --> convert_to_gitlab_ci;
...
graph TD;
    ...
    check_false_positive_status(check_false_positive_status<br>#91;AgentComponent#93;);
    create_repository_branch(create_repository_branch<br>#91;AgentComponent#93;);
    ...
    gather_context --> check_false_positive_status;
    check_false_positive_status -.->|proceed_with_fix| create_repository_branch;
    check_false_positive_status -.->|skip_false_positive| __end__;
    ...
    push_and_create_mr --> link_vulnerability;
