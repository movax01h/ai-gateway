...
graph TD;
    ...
    add_plan_comment(add_plan_comment<br>#91;OneOffComponent#93;);
    ...
    planning_agent --> add_plan_comment;
    add_plan_comment --> programming_agent;
...
graph TD;
    ...
    add_plan_comment --> programming_agent;
    programming_agent --> git_actions;
    git_actions -.->|success| __end__;
    git_actions -.->|failed| abort;
    classDef default fill:#f2f0ff,line-height:1.2;
    classDef first fill-opacity: 0;
    classDef last fill:#bfb6fc;
```
...
graph TD;
    ...
    fix_pipeline_next_comment_existing_mr(fix_pipeline_next_comment_existing_mr<br>#91;OneOffComponent#93;);
    ...
    fix_pipeline_next_decide_approach -.->|create_fix_on_new_mr| create_repository_branch;
    fix_pipeline_next_decide_approach -.->|create_fix_on_existing_mr| fix_pipeline_next_checkout_existing_branch;
    fix_pipeline_next_decide_approach -.->|default_route| fix_pipeline_add_comment;
    fix_pipeline_add_comment --> __end__;
    fix_pipeline_next_checkout_existing_branch --> fix_pipeline_create_plan;
    create_repository_branch --> fix_pipeline_create_plan;
    fix_pipeline_create_plan --> fix_pipeline_execution;
    fix_pipeline_execution --> fix_pipeline_git_commit;
    fix_pipeline_git_commit --> fix_pipeline_git_push;
    fix_pipeline_git_push -.->|create_fix_on_existing_mr| fix_pipeline_next_comment_existing_mr;
    fix_pipeline_git_push -.->|create_fix_on_new_mr| fix_pipeline_next_create_new_mr;
    fix_pipeline_git_push -.->|default_route| fix_pipeline_next_create_new_mr;
    fix_pipeline_next_comment_existing_mr --> __end__;
