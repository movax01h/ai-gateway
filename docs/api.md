...
| `prompt_components.payload.model`              | string | yes      | The AI model for which the prompt is designed for. Valid values are: `claude-sonnet-4-6`,`claude-haiku-4-5-20251001`, `claude-opus-4-7`,                 | `claude-sonnet-4-6`                                    |
