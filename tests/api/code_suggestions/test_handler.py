...
@pytest.fixture(
    name="api_version",
    params=[
        pytest.param(("v3", v3_api_router, "/code/completions"), id="v3"),
        pytest.param(("v4", v4_api_router, "/code/suggestions"), id="v4"),
    ],
    scope="class",
)
...
def fast_api_router_fixture(api_version):
    return api_version[1]


@pytest.fixture(name="route")
def route_fixture(api_version):
