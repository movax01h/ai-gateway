...
MAX_MODEL_TOTAL_TOKENS = Gauge(
    "model_max_total_tokens",
    "The maximum total tokens limit for a model",
    METRIC_LABELS,
)
...
INFERENCE_TOTAL_TOKENS = Counter(
    "inference_total_tokens",
    "The total number of tokens (input + output) processed by the model",
    INFERENCE_DETAILS,
)
    ...
    class WatchContainer:
        ...
        def start(self):
            ...
            if self.limits:
                ...
                if "total_tokens" in self.limits:
                    MAX_MODEL_TOTAL_TOKENS.labels(**self.labels).set(
        ...
        def register_token_usage(
            ...
            INFERENCE_TOTAL_TOKENS.labels(**token_usage_labels).inc(
                usage["total_tokens"]
            )
